...
class PreferencePolicy
{
    ...
    {
        return $user->userCanDo('Preference', 'browse');
    }
    ...
    {
        return $user->userCanDo('Preference', 'read');
    }
    ...
    {
        return $user->userCanDo('Preference', 'add');
    }
    ...
    {
        return $user->userCanDo('Preference', 'edit');
    }
    ...
    {
        return $user->userCanDo('Preference', 'delete');
    }

                        ...
                        <table class="table table-bordered table-hover table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span
                                            class="badge badge-{{ $activity->description == 'deleted' ? 'danger' : ($activity->description == 'created' ? 'success' : 'info') }}">{{
                                            $activity->description }}</span>
                                    </td>
                                    <td>{{ $activity->subject_type }}</td>
                                    <td>{{ $activity->subject_id }}</td>
                                    <td><a
                                            href="{{ url(config('adminetic.prefix', 'admin') . '/' . 'user/' . $activity->causer_id) }}">{{
                                            (\App\Models\User::find($activity->causer_id))->name ?? '-' }}</a>
                                    </td>
                                ...
                                @else
                                <tr>
                                    <td colspan="8"><span class="d-flex justify-content-center">No Activity Registered
                                            Yet.</span></td>
                                </tr>
                                @endif
                            </tbody>
            ...
            <div class="card">
                <div class="card-body shadow-lg p-2">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="input-group">
                                <span class="input-group-text"><input type="number" wire:model.debounce.500ms="interval"

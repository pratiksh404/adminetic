    ...
    <div class="row">
        <div class="col-xl-7">
            <img class="bg-img-cover bg-center fadeIn animated"
                src="{{ asset(isset($setting->login_register_bg_image) ? 'storage/' . $setting->login_register_bg_image : 'adminetic/static/login_register_bg_img.jpg') }}"
                alt="loginpage">
        </div>
                ...
                <div class="login-main">
                    <form class="theme-form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('email')shake animated @enderror" type="email" name="email"

                                ...
                                <ul>
                                    @foreach ($group as $setting)
                                        @if ($setting->getRawOriginal('setting_type') == 1)
                                            @include('adminetic::admin.layouts.modules.setting.components.string')
                                        @elseif ($setting->getRawOriginal ('setting_type') == 2)
                                            @include('adminetic::admin.layouts.modules.setting.components.integer')
                                        @elseif ($setting->getRawOriginal ('setting_type') == 3)
                                            @include('adminetic::admin.layouts.modules.setting.components.text')
                                        @elseif ($setting->getRawOriginal ('setting_type') == 4)
                                            @include('adminetic::admin.layouts.modules.setting.components.rich_text')
                                        @elseif ($setting->getRawOriginal ('setting_type') == 5)
                                            @include('adminetic::admin.layouts.modules.setting.components.switch')
                                        @elseif ($setting->getRawOriginal ('setting_type') == 6)
                                            @include('adminetic::admin.layouts.modules.setting.components.checkbox')
                                        @elseif ($setting->getRawOriginal ('setting_type') == 7)
                                            @include('adminetic::admin.layouts.modules.setting.components.select')
                                        @elseif ($setting->getRawOriginal ('setting_type') == 8)
                                            @include('adminetic::admin.layouts.modules.setting.components.multiple')
                                        @elseif ($setting->getRawOriginal ('setting_type') == 9)
                                            @include('adminetic::admin.layouts.modules.setting.components.tag')
                                        @elseif ($setting->getRawOriginal ('setting_type') == 10)
                                            @include('adminetic::admin.layouts.modules.setting.components.image')
                                        @endif
                                    @endforeach
                                </ul>
                            </div>

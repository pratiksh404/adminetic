    ...
    $(function(){
      ...
      function changeFontColor(){
         if (localStorage.getItem('mode') == "dark-only") {
            $('.sidebar-link i').removeClass("text-dark");
            $('.sidebar-link i').addClass("text-light");
         }
         if (localStorage.getItem('mode') == "light") {
            $('.sidebar-link i').removeClass("text-light");
            $('.sidebar-link i').addClass("text-dark");
         }
      }
  });
</script>
...
<script>
    ...
    var customizer = '<div class="customizer-links">' +
        ...
        '            class="nav-link" id="c-pills-layouts-tab" data-bs-toggle="pill" href="#c-pills-layouts" role="tab"' +
        '            aria-controls="c-pills-layouts" aria-selected="true" data-original-title="" title="">' +
        '            <div class="settings"><i class="icon-paint-bucket"></i></div> <span>Check layouts</span>' +
        '        </a> <a class="nav-link" id="c-pills-home-tab" data-bs-toggle="pill" href="#c-pills-home" role="tab"' +
        '            aria-controls="c-pills-home" aria-selected="true" data-original-title="" title="">' +

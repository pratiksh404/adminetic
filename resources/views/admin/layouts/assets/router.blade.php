      ...
      function serverRequest(url,request_type,data){
        ...
        $(window).on({
            ...
            function loadPage(route){
                ...
                var loader = '<div style="position: absolute;left: 0;right: 0;top: 40%;bottom: 0;margin: auto;max-width: 100%;max-height: 100%;overflow: auto;"><div class="loader-box" style="margin:auto"><div class="loader-2"></div></div></div>';
                   $.ajax({
                      url: route,
                      type: "GET",
                      beforeSend: function(xhr){
